	...
	return (
		<div className="flex justify-center text-[#7476a7] my-[50px] mx-[0px]">
			<div className="flex flex-col text-center max-lg:w-[80%] max-lg:items-center">
				<div className="w-[1440px] flex justify-between flex-wrap max-xl:w-[100%] max-lg:flex-col max-lg:justify-center max-lg:items-center max-lg:gap-4 max-2xl:w-[900px]">
